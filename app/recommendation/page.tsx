                    ...
                    {recom.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                />
                                <div className='w-[70vw] h-[35vh] flex flex-col justify-start items-start gap-2'>
                                    <h2 className="text-4xl font-semibold text-white">{anime.title}</h2>
                                    ...
                                    <div className="w-full flex-1 overflow-y-auto pr-2 [&::-webkit-scrollbar]:hidden">
